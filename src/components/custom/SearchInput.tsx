  ...
  ({ className, ...props }, ref) => {
    return (
      ...
      >
        ...
        <input
          className="w-full p-2 bg-transparent placeholder:text-muted-foreground focus-visible:outline-none placeholder:text-green-200 disabled:cursor-not-allowed disabled:opacity-50"
          type="search"
          ref={ref}
          {...props}
        />
