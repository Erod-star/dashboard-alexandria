// ? REFERENCE: https://shadcnui-expansions.typeart.cc/docs/datetime-picker
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: 'absolute left-4 top-3 text-black',
        nav_button_next: 'absolute right-4 top-3 text-black',
        ...
        day_selected:
          'bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground rounded-l-md rounded-r-md', // Cambié 'selected' a 'day_selected'// today: 'bg-accent text-accent-foreground',
        day_outside:
      ...
      //       <button
      //         {...props}
      //         className={cn('h-7 w-7 p-0 opacity-50 hover:opacity-100')}
      //       >
      ...
      //             onValueChange={(value) => {
      //               displayMonth.setMonth(Number.parseInt(value, 10));
      //               props.onMonthChange?.(displayMonth);
      //             }}
      //           >
      ...
      //             onValueChange={(value) => {
      //               displayMonth.setFullYear(Number.parseInt(value, 10));
      //               props.onMonthChange?.(displayMonth);
      //             }}
      //           >
      //             <SelectTrigger className="w-fit gap-1 border-none p-0 focus:bg-accent focus:text-accent-foreground">
